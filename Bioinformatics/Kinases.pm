...
=head2 new
  ...
  Description  : A constructor to build a new object that calls _readKinases to get an Array of Hashes for each kinase entry in file.
...
=head2 printKinases
  ...
  Examples    : $kinaseObj->printKinases($fileOutName, ['symbol','name','location'] )';
...
=head2 filterKinases
  ...
  Description : Returns a new Kinases object which containing the kinases passing the filter fields or a copy of the object if no filters passed.
